...
#define LEINAD_WINDOW_FLAGS 0 | SDL_WINDOW_MOUSE_GRABBED | SDL_WINDOW_MOUSE_CAPTURE | SDL_WINDOW_MOUSE_RELATIVE_MODE | SDL_WINDOW_FULLSCREEN // | SDL_WINDOW_SURFACE_VSYNC_DISABLED
